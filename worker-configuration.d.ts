/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 42fea5578c55b7b58a18c0496bbe3520)
// Runtime types generated with workerd@1.20251105.0 2025-11-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NUXT_LOGIN_CODE_URL: string;
		NUXT_GET_NAME_URL: string;
		NUXT_SECRET_KEY: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_LOGIN_CODE_URL" | "NUXT_GET_NAME_URL" | "NUXT_SECRET_KEY">> {}
}
